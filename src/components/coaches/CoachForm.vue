<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !rate.isValid}">
            ...
            <textarea type="number" id="rate" v-model.number="rate.val" @blur="clearValidity('rate')"></textarea>
            <p v-if="!rate.isValid">Rate must be greater than 0.</p>
        </div>
        <div class="form-control" :class="{invalid: !areas.isValid}">
            <h3>Areas of Expertise</h3>
            <!-- when working wih checkboxes they are all assigned to the same array because they all belong together-->
            <div>
...
export default {
    ...
    methods: {
        clearValidity(input) {
            /*we expect to get the input name here as an argument */
            /* we then reach out to any data property and set the isValid propert to true  */
            /* this method would only be called on the blur event */
